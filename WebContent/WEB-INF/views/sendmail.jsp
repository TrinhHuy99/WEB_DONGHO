...
<%@ include file="header.jsp"%>
	...
	<span style="margin-left: 530px;">Địa chỉ Email: huytrinh2713@gmail.com</span>
	<h3 style="color: red; margin-left: 450px; margin-top: 10px;">${message}</h3>
	<form action="send.htm" method="post">
		<p><input name="from" placeholder="Email của bạn!"></p>
		<p><input name="to" placeholder="To" value="huytrinh2713@gmail.com"></p>
