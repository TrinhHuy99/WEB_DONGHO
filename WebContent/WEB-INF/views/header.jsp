	...
	<div class="container">
		<header>
			<ul>
				<li>
					<p>
						HOTLINE :<a href="tel:0387 112 713" class="phone"><span style="font-weight: bold; padding-left:10px" >0387 112 713
								</span></a>
					</p>
				</li>
				<li class="bb"><img alt="home.htm" 
					src="<c:url value="/resources/theme/images/logo-shopwatch.png" />"></li>
				
					
						<li><a href="dangnhap.htm" class="login">ĐĂNG NHẬP</a></li>
						<li><a href="dangky.htm" class="login">ĐĂNG KÝ</a></li>
					
				<li><a href="GioHang.htm?id=CS01&name=ĐỒNG HỒ ORIENT NAM DÂY KIM LOẠI&gia=500000&image=C01.jpg"><i class="fa fa-cart-plus"
			...
			<ul>
				...
				<li><a href="">TIN TỨC <i class="fa fa-angle-down"></i></a>
					<ul class="GT">
						...
						<li><a href="TuVan.htm">Tư vấn</a></li>
